...
__title__ = 'Gatekeeper Authenticator Service'
__author__ = 'Simon Belete'
__keywords__ = ''
__repo_name__ = 'Gatekeeper Authenticator Service'
__description__ = 'Guyas Authintactor Service'
__project_name__ = 'Gatekeeper Authenticator Service'
